...
import { LuArrowBigRight, LuPlay, LuSparkles } from "react-icons/lu";
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center relative w-full">
        <div className="max-w-7xl mx-auto flex-col lg:grid lg:grid-cols-2 text-center lg:text-left  gap-6 sm:gap-8 lg:gap-12 items-center">
          {/* right side */}
          <div>
            <div className="inline-flex items-center space-x-2 px-3 sm:px-4 bg-blue-500/10 border border-blue-500/20 rounded-full mb-4 sm:mb-6 animate-in slide-in-from-bottom duration-700">
            ...
            <h1 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold mb-4 sm:mb-6 animate-h slide-in-from-bottom duration-700 delay-100 leading-tight">
              ...
              <span className="bg-gradient-to-r from-white via-blue-100 to-cyan-100 bg-clip-text text-transparent block mb-1 sm:mb-2">
                Website With PixelLab{" "}
              </span>
            </h1>
            <p className="text-md sm:text-base lg:text-lg text-gray-400 mb-6 sm:mb-8 max-w-2xl mx-auto lg:mx-0 animate-in slide-in-from-bottom duration-700 delay-200 leading-relaxed">
              In an era of digital threats, a beautiful website isn't enough. We
              design and develop custom web platforms with built-in defense
              ...
              <button className="group w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-b from-blue-600 to-slate-950 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 hover:scale-102 flex items-center justify-center space-x-2">
               ...
               <button className="group w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-t from-white/5 to-slate-950 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 hover:bg-white/10 flex items-center justify-center space-x-2 border border-white/10">
                <div className="p-2 bg-white/10 rounded-full group-hover:bg-white/20 duration-300 transition-colors">
                  <LuPlay className="w-4 sm:w-5 h-4 sm:h-5 fill-white"/>
                </div>
          ...
          <div className="relative order-2 w-full">
            <div className="relative bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-white/10">
                ...
                <div className="flex items-center justify-between px-3 sm:px-4 py-2 sm:py-3 bg-white/5 backdrop-blur-sm border-b border-white/5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs sm:text-sm text-gray-300 font-bold">
                      Pixel<span className="text-blue-300 font-bold">Lab</span>
                    </span>
                  </div>
                  <MdArrowDropDown className="sm:w-4 sm:h-4 text-gray-4001" />
                </div>
              ...
              <div
                className={`hidden lg:block absolute bottom-4 right-4  transfrom translate-x-8 translate-y-8 w-72 ${currentFloatingCard.bgColor}  backdrop-blur-xl rounded-lg p-4 border border-white/20 shadow-2xl   `}
              >
